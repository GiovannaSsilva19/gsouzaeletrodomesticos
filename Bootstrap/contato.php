...
<body>
    ...
    <div  class="container d-flex ">
        <div class="contatos w-25 mt-5">
           <img class="imgContato"src="./img/email"alt='logo email'>
           <a class="link text-dark"href="Gsouzaeletro@hotmail.com">Gsouzaeletro@hotmail.com</a>        
            <img class="imgContato" src="./img/whats"alt='Logo Whatsapp'>
            <a class="textoContato text-dark" href="contato(11)95232-6488">(11)95232-6488</a>              
        </div>
     <div class="formContato ml-5 mb-5">    
      <form action="" method="post">
        <div class="formulario w-75  mb-5">
        <h2 class="text text-info">Preencha os campos abaixo para entrar em contato:</h2>
