...
<body>
  ...
  <section class='categorias'>
    ...
    <ul>
      ...
      <li onclick="exibir_categoria('geladeira')">Geladeiras (03)</li>
      <li onclick="exibir_categoria('fogao')">Fogões (02)</li>
      <li onclick="exibir_categoria('microondas')">Microondas(03)</li>
      <li onclick="exibir_categoria('lavadoura')">Lavadoura de Roupa (02)</li>
      <li onclick="exibir_categoria('lavaLouca')">Lava-Louças (02)</li>
    </ul>
  </section>
